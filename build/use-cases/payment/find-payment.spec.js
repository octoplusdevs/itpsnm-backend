...
// src/use-cases/payment/find-payment.ts
var FindPaymentByIdUseCase = class {
...
// src/use-cases/payment/find-payment.spec.ts
...
describe("FindPaymentByIdUseCase", () => {
  it("should find a payment by ID", async () => {
    ...
    globalExpect(payment.id).toEqual(globalExpect.any(Number));
    globalExpect(payment.state).toBe("PENDING");
  });
});
