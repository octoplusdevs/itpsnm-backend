...
// src/use-cases/file/update-file.spec.ts
var import_client = require("@prisma/client");

// src/use-cases/file/update-file.ts
var UpdateFileUseCase = class {
...
describe("UpdateFileUseCase", () => {
  ...
  it("should update a file", async () => {
    ...
    globalExpect(updatedFile).not.toBeNull();
    globalExpect(updatedFile?.name).toBe("updated-file");
  });
});
