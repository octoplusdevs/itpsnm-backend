...
// src/use-cases/student/destroy-student.ts
var DestroyStudentUseCase = class {
  constructor(studentsRepository2) {
    this.studentsRepository = studentsRepository2;
  }
  async execute({
    studentId
  }) {
...
// src/use-cases/student/destroy-student.spec.ts
