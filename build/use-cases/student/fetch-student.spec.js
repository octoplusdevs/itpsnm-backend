...
// src/use-cases/student/fetch-student.spec.ts
...
describe("Fetch Students Use Case", () => {
  ...
  it("should be able to fetch a list of students", async () => {
    await studentRepository.create({
      ...
      dateOfBirth: /* @__PURE__ */ new Date("2000-08-01"),
    ...
    globalExpect(students.totalItems).toBe(1);
    globalExpect(students.items).toEqual([
      globalExpect.objectContaining({ fullName: "Wilmy Danguya" })
    ]);
  });
  it("should be able to fetch paginated course", async () => {
    ...
    globalExpect(students.totalItems).toBe(22);
    globalExpect(students.items).toEqual([
      globalExpect.objectContaining({ fullName: "Wilmy Danguya 21" }),
      globalExpect.objectContaining({ fullName: "Wilmy Danguya 22" })
    ]);
  });
});
