...
var GetDocumentUseCase = class {
  constructor(documentsRepository2) {
    this.documentsRepository = documentsRepository2;
  }
  async execute({
    documentId
  }) {
...
// src/use-cases/document/get-document.spec.ts
...
var createDocumentWithFilesUseCase;
var sut;
describe("Get Document Use Case", () => {
  ...
  it("should be able to get a document by id", async () => {
    ...
    globalExpect(document?.id).toEqual(1);
    globalExpect(document?.enrollmentId).toEqual(1);
  });
