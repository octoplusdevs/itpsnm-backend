...
var make_file_use_case_exports = {};
__export(make_file_use_case_exports, {
  makeCreateFileUseCase: () => makeCreateFileUseCase
});
module.exports = __toCommonJS(make_file_use_case_exports);
...
var CreateFileUseCase = class {
  ...
  async execute({ name, path, format, type, identityCardNumber, documentId }) {
