...
var GetEnrollmentUseCase = class {
  constructor(enrollmentsRepository2) {
...
// src/use-cases/enrollment/get-enrollment.spec.ts
...
describe("Get Enrollment Use Case", () => {
  ...
  it("should be able to get a enrollment by id", async () => {
    ...
    globalExpect(enrollment?.id).toBe(1);
    globalExpect(enrollment?.docsState).toEqual("APPROVED");
    globalExpect(enrollment?.paymentState).toEqual("REJECTED");
  });
