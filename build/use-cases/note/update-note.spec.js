...
// src/use-cases/note/update-note.spec.ts
var notesRepository;
var sut;
describe("Update Note Use Case", () => {
  ...
  it("should update an existing note", async () => {
    ...
    globalExpect(response.note).toBeTruthy();
    globalExpect(response.note?.pf1).toEqual(12);
    globalExpect(response.note?.pf2).toEqual(18);
    globalExpect(response.note?.pft).toEqual(19);
  });
  it("should return null if note is not found", async () => {
    ...
    globalExpect(response.note).toBeNull();
  });
});
