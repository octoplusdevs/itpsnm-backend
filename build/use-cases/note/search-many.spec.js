...
// src/use-cases/note/search-many.spec.ts
var notesRepository;
describe("Search Many Notes Use Case", () => {
  ...
  it("should return notes with calculated grades that match the search criteria", async () => {
    ...
    globalExpect(response.length).toBe(2);
    globalExpect(response[0].enrollmentId).toEqual(123);
    globalExpect(response[0].subjectId).toEqual(1);
    globalExpect(12.333333333333334).toBeCloseTo((10 + 15 + 12) / 3);
    globalExpect(7.666666666666667).toBeCloseTo((5 + 10 + 8) / 3);
  });
});
