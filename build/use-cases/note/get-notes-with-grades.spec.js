...
// src/use-cases/note/get-notes-with-grades.spec.ts
var notesRepository;
var getNoteWithGradesUseCase;
describe("Get Note With Grades Use Case", () => {
  ...
  it("should return the note with calculated grades for 10th class", async () => {
    ...
    globalExpect(note).toBeTruthy();
    globalExpect(12.333333333333334).toBe((10 + 15 + 12) / 3);
  });
});
